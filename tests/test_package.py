...
class TestPackage(unittest.TestCase):
    ...
    def test_deliver_updates_status(self):
        ...
        self.assertEqual(self.pkg.status, Package.DELIVERED)
    ...
    def test_get_address_correction(self):
        ...
        self.assertEqual(self.pkg.get_address(before_correction), self.pkg.original_address)
        self.assertEqual(self.pkg.get_address(after_correction), "410 S State St")
